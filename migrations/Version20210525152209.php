 ...
 */
final class Version20210525152209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, id_adherent INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, montant_paye INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
