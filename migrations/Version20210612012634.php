 ...
 */
final class Version20210612012634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, reference VARCHAR(255) NOT NULL, lib VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, prix_ttc DOUBLE PRECISION NOT NULL, tva DOUBLE PRECISION NOT NULL, id_fournisseur INT NOT NULL, stock_max INT NOT NULL, stock_alerte INT NOT NULL, fraix_stockage DOUBLE PRECISION NOT NULL, poid DOUBLE PRECISION NOT NULL, image VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
