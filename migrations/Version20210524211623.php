 ...
 */
final class Version20210524211623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE groupe_adherent (id INT AUTO_INCREMENT NOT NULL, id_adherent VARCHAR(255) NOT NULL, id_groupe VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
