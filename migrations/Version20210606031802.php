 ...
 */
final class Version20210606031802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance ADD type VARCHAR(255) NOT NULL, ADD objectif VARCHAR(255) NOT NULL, ADD autre_info VARCHAR(255) NOT NULL, ADD objectif_suivant VARCHAR(255) NOT NULL, ADD etat VARCHAR(255) NOT NULL, ADD code_sequence VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance DROP type, DROP objectif, DROP autre_info, DROP objectif_suivant, DROP etat, DROP code_sequence');
