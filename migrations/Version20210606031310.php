 ...
 */
final class Version20210606031310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance ADD type VARCHAR(255) NOT NULL, ADD objectif VARCHAR(255) NOT NULL, ADD autre_info VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE seance DROP type, DROP objectif, DROP autre_info');
